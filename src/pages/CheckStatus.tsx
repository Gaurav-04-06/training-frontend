...
const CheckStatus: React.FC = () => {
  ...
  return (
    <div className='max-w-6xl mx-auto px-6 py-10 bg-white/80 backdrop-blur-lg rounded-3xl shadow-[0_10px_60px_-10px_rgba(0,0,0,0.3)] mt-14 mb-12'>
      <h2 className='text-5xl font-extrabold text-center bg-gradient-to-r from-teal-500 to-blue-500 text-transparent bg-clip-text mb-12 uppercase tracking-wide'>
        Check Status
      </h2>
      ...
      {loading ? (
        ...
        <div ref={printRef} className='text-gray-800'>
          {/* Personal Details */}
          <fieldset className='border-l-4 border-teal-500 bg-white rounded-xl p-6 mb-10 shadow-md'>
            <legend className='text-xl font-semibold text-teal-600 px-2'>
              Personal Details
            </legend>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-4'>
              <input
                className='bg-gray-50 border border-gray-300 px-4 py-2 rounded-lg'
          ...
          {/* Issue Details */}
          <fieldset className='border-l-4 border-blue-500 bg-white rounded-xl p-6 mb-10 shadow-md'>
          ...
          {/* Previous Remarks */}
          <div className='bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6 shadow-inner'>
            ...
            <textarea
              ...
              value={requestData.requestRemarks}
            />
            <button className='mt-4 px-4 py-2 rounded-lg bg-blue-200 text-blue-900 hover:bg-blue-300 transition'>
              Add Remark
            </button>
          </div>
          ...
          <button
            onClick={handlePrint}
            className='mt-4 px-6 py-2 rounded-xl bg-emerald-200 text-emerald-900 hover:bg-emerald-300 shadow transition-all'>
            Download as PDF
          </button>
        </div>
      )}
